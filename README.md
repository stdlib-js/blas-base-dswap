...
```javascript
dswap = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-dswap@v0.0.8-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-dswap@v0.0.8-umd/browser.js"></script>
```
